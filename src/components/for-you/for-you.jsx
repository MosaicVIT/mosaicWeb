      ...
      <div className="box-container">
        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((item, index) => {
          if (index % 6 === 0)
            ...
            return (
              <Box data={data} key={index} bgColor="#D093FF" textColor="#000" />
            );
          else if (index % 6 === 2)
            return (
              <Box
            ...
            return (
              <Box data={data} key={index} bgColor="#939AFF" textColor="#000" />
            );
          else if (index % 6 === 4)
            return (
              <Box
            ...
            return (
              <Box data={data} key={index} bgColor="#93EDFF" textColor="#000" />
            );
        })}
      </div>
    </div>
